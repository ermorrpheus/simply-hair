      ...
      <div className="bg-black/70 px-4 py-24 sm:px-6 lg:px-8">
        <div className="">
          ...
          <p className="mt-6 max-w-lg text-sm text-white/90 md:block md:text-base md:leading-relaxed">
            Dive into the world of Simply Hair with our exclusive Hair Clipping
            newsletter. From the latest styling trends and haircare tips to
            special promotions and salon events, we&apos;ve got you covered.
