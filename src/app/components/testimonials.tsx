...
export function Testimonials() {
  return (
    <section className="bg-gray-50 px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
      <div className="">
        <div className="md:flex md:items-end md:justify-between">
          <div className="max-w-xl">
            <h2
              className={`${playfair.className} text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl`}
            >
