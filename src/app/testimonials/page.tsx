...
export default function TestimonialsPage() {
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-gray-50 px-4 py-12 sm:px-6 sm:py-24 lg:px-8">
        <div className="">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            <blockquote className="flex h-full flex-col justify-between rounded bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  <p className="text-xl font-bold  sm:text-2xl">What A Find</p>
            ...
            <blockquote className="flex h-full flex-col justify-between rounded bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  <p className="text-xl font-bold  sm:text-2xl">So Relaxing</p>
            ...
            <blockquote className="flex h-full flex-col justify-between rounded bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  <p className="text-xl font-bold  sm:text-2xl">Clean Beauty</p>
              ...
              <div>
                ...
                <div className="mt-4">
                  <p className="text-xl font-bold  sm:text-2xl">
                    Hair Game Transformed
                  </p>

                  <p className="mt-4 text-sm leading-relaxed text-gray-700 md:text-base">
                    Simply Hair has transformed my hair game! The stylists truly
                    understand my needs and always leave me feeling fabulous.
            ...
            <blockquote className="flex h-full flex-col justify-between rounded bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-gray-700 md:text-base">
                    The makeup session I had at Simply Hair was a game-changer.
                    I learned so much about what works for my skin tone and face
                    shape. Left the salon feeling like a million bucks!
                  </p>
                </div>
              </div>
            ...
            <blockquote className="flex h-full flex-col justify-between rounded bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  <p className="text-xl font-bold  sm:text-2xl">Hair Savers</p>

                  <p className="mt-4 text-sm leading-relaxed text-gray-700 md:text-base">
                    I came in for a corrective color after a mishap at another
                    salon. The team at Simply Hair not only fixed it but made it
                    look even better than I originally wanted. They truly are
                    hair saviors!{" "}
                  </p>
                </div>
              </div>
